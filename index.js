...
const exampleKey = '0xd9873d79c6d87dc0ff6a5778633389f4453213303da61f20bd67fc233aa33262';
...
// ===================================demo================================================
var secretKey='0xd9873d79c6d87dc0ff6a5778633389f4453213303da61f20bd67fc233aa33262';
console.log('========Original Secret========',{secretKey});
var splitedShares = split(secretKey,4,2,prime512);
console.log('========Devided Secret Into 4 Parts========',{splitedShares});
var originalSecretKey=combine([ splitedShares[1], splitedShares[2]],prime512).toHex();
console.log('========Original Secret After Combining 2 Shares========',{originalSecretKey});
